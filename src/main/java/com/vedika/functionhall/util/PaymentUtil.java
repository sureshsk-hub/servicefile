...
public class PaymentUtil {
	...
	private static final String sUrl = "http://localhost:8057/api/payment/payment-response";

	private static final String fUrl = "http://localhost:8057/api/payment/payment-response";
